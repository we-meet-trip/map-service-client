...
2026-09-07 개인정보처리방침 revision `2026-09-07.1`: 생년월일을 보호 서비스 이용 전 필수 연령 확인 항목으로 안내한다. 약관 버전 `2026-09-07`은 유지한다. 이전 privacy 동의가 있는 성인 계정도 새 방침에 동의해야 하며 기존 동의 행을 백필하지 않는다. 자기 입력은 본인인증이 아니다.
