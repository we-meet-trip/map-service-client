...
const Map<String, PlaceDetail> mockPlaceDetails = {
  ...
  'p5': PlaceDetail(
    ...
    blogReviews: [
      ...
      BlogReview(
        title: '홍대 벽화 골목 산책 – 예술의 거리',
        blogName: '거리 예술 탐방가',
        date: '2024-11-10',
        snippet: '홍대 골목 곳곳에 숨어있는 벽화들을 찾아다니는 재미가 있어요. 사진 찍기도 좋고 분위기도 독특합니다.',
      ),
      BlogReview(
        title: '홍대 주변 게스트하우스 솔직 후기',
        blogName: '배낭여행자 일기',
        date: '2024-10-20',
        snippet: '외국 여행객들도 많이 찾는 홍대 게스트하우스. 가성비 좋고 위치도 최고라 다음에도 여기 올 것 같아요.',
      ),
      BlogReview(
        title: '홍대 앞 스트릿 푸드 완전 정복',
        blogName: '길거리 음식 전문가',
        date: '2024-09-05',
        snippet: '닭꼬치, 타코야키, 마라탕까지 홍대 거리 음식이 정말 다양해요. 저녁 시간대가 제일 활기차고 맛있습니다.',
      ),
      BlogReview(
        title: '홍대 소품샵 투어 – 선물 고르기 완벽 코스',
        blogName: '소품 수집가',
        date: '2024-07-30',
        snippet: '독특한 소품들이 넘치는 홍대 소품샵들. 친구 선물이나 여행 기념품 고르기에 최고의 장소입니다.',
      ),
    ],
  ),
  'p6': PlaceDetail(
