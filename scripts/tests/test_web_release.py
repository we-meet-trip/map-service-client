...
assert set(defines)=={'APP_ENV','API_ALLOWED_ORIGINS','APP_CONFIG_URL','INVITE_LINK_ORIGIN','PUBLIC_SITE_ORIGIN','NATIVE_APPLICATION_ID','INVITE_URL_SCHEME','GOOGLE_MAPS_WEB_API_KEY'}
